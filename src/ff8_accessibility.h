...
// refuse to push.
// ================================================================
#define FF8OPC_VERSION "0.18.3.31"  // v0.18.3.31: #62 -- gate off the battle damage-number diagnostic screenshots that flooded Logs/screenshots every battle (poll_*, popup_time_*, popup_change_*, kind4_*, sprite_animflag_*, roi_calib_*). New master flag BATTLE_DIAG_SCREENSHOTS (battle_tts.h, default 0) gates FireAnimFlagScreenshot / PollSpriteScreenshot / FirePopupTimeDiagCapture / FirePopupChangeCapture / SchedulePendingKind4Capture; ROI_CALIBRATION_CAPTURE now follows it. Diagnostic code retained behind the flag (gate, don't delete). F11 + victory screenshots route through different paths and are unaffected.
